...
class TranslationService
{
    ...
    {
        //dd(...$this->orderBy(TranslationFilter::SORTABLE));
        //return Translation::orderBy(...$this->orderBy(TranslationFilter::SORTABLE))->filter()->paginate($this->perPage())->withQueryString();
        return Translation::join('languages', 'translations.language_id', '=', 'languages.id')->select('translations.*')->orderBy(...$this->orderBy(TranslationFilter::SORTABLE))->filter()->paginate($this->perPage())->withQueryString();
    }
